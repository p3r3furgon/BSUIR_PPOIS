...
class EnterNameMenu:
    ...
    def __init__(self):
        ...
        self.background_image = pygame.image.load("./images/battlefield/battlefield_1.png")
...
class MainMenu:
    ...
    def __create_info_window():
        ...
        background_image = pygame.image.load("./images/battlefield/battlefield_1.png")
                ...
                if event.type == pygame.QUIT:
                    ...
                    if self.start_button.rect.collidepoint(mouse_pos):
                        ...
                        game = Game('Vlad\'s Asteroid Adventure', width=1000, height=1000,
                                    back_image_filename='images/battlefield/battlefield_1.png',
                                    frame_rate=40)
                        print('action')
                        result = game.run()
                        print(result)
